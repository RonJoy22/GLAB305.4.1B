...
public class UserController {
    ...
    private static void deleteUser(Session session, int i) {
    }

    private static void updateUser(Session session, int i) {
    }

    private static void findUser(SessionFactory factory, Session session, int i) {
    }
